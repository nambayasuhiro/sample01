          ...
          <div class="row justify-content-center">
            <div class="col-12">
              <div class="text-center">
                <h1 class="display-sm-4 display-lg-3">Yasuhiro Namba</h1>
                <p class="h6 text-uppercase u-letter-spacing-sm mb-2">3人娘のパパ</p>
        ...
        <div class="container">
          ...
          <div class="row u-content-space-bottom">
            <div class="col-lg-6 mb-5 mb-lg-5 pl-lg-5">
              ...
              <p>Yasuhiro　Namba</p>
              <p>1991/12/18</p>
              <p>愛知県生まれ。高卒で大手自動車メーカー勤務。</p>
              <p>20歳で結婚し、28歳の現在は3人の娘をもつパパに。</p>
              <p>26歳の時に、youtubeでマ多くのビジネス系youtuberの存在を知ったことをきっかけに、このままではいけないと思い即座にプログラミングスクールに入校。</p>
              <p>そして今現在、サラリーマン兼フリーランスとして、web制作を中心にやシステム開発、マーケティングまで支援いたします。</p>
            ...
            <div class="col-lg-6">
              ...
              <hr>
              <!-- Progress Bar -->
              <h5 class="u-font-size-90 mb-1">PHP・Laravel - 93%</h4>
              ...
              <!-- Progress Bar -->
              <h5 class="u-font-size-90 mb-1">html/css - 76%</h4>
              <div class="progress mb-3">
              ...
              <!-- Progress Bar -->
              <h5 class="u-font-size-90 mb-1">WIX - 80%</h4>
              <div class="progress mb-3">
              ...
              <!-- End Progress Bar -->
                            <!-- Progress Bar -->
                            <h5 class="u-font-size-90 mb-1">マーケティング - 90%</h4>
                              <div class="progress mb-3">
